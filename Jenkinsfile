pipeline {
    ...
    parameters {
        ...
        string(name: 'PM2_NAME', defaultValue: 'dev.admin.leyenshop.net', description: 'PM2 app name')
        string(name: 'WORK_DIR', defaultValue: '/root/leyenshop/dev/leyenshop-admin-nextjs', description: 'Working directory')
        string(name: 'GITHUB_REPO_URL', defaultValue: 'https://github.com/windduongcorp/leyenshop-admin-nextjs', description: 'GitHub repository URL')
    ...
    environment {
        APP_NAME = "admin.leyenshop"
        REPO_URL = "git@github.com:windduongcorp/leyenshop-admin-nextjs.git"
